...
CREATE TABLE users (
  ...
  nickname varchar(255) not null comment 'ユーザ　ニックネーム',
...
CREATE TABLE craft_location (
  ...
  craft_japanesename varchar(255) not null comment '工芸品　日本語名前',
  craft_url varchar(255) not null comment '工芸品　説明文URL',
...
CREATE TABLE craft_characteristic (
  craft_id int(10) unsigned not null auto_increment comment '工芸品　ID',
  craft_description varchar(255) not null comment '特徴語　説明文',
  ...
  era varchar(255) not null comment '特徴語　年代', 
